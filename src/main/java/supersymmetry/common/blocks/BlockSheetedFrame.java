...
public class BlockSheetedFrame extends Block {
    ...
    public static final PropertyEnum<BlockSheetedFrame.FrameEnumAxis> SHEETED_FRAME_AXIS = PropertyEnum.<BlockSheetedFrame.FrameEnumAxis>create(
            "axis", BlockSheetedFrame.FrameEnumAxis.class);
    ...
    public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY,
        ...
        return this.getStateFromMeta(meta).withProperty(SHEETED_FRAME_AXIS,
                BlockSheetedFrame.FrameEnumAxis.fromFacingAxis(facing.getAxis()));
    }
