...
public class SusyTextures {
    ...
    public static final OrientedOverlayRenderer COOLING_UNIT_OVERLAY = new OrientedOverlayRenderer(
            "machines/multiblocks/cooling_unit");
    ...
    public static final OrientedOverlayRenderer OCEANIC_DRILL_OVERLAY = new OrientedOverlayRenderer(
            "machines/multiblocks/oceanic_drill");
    ...
    public static final SimpleOverlayRenderer SILICON_CARBIDE_CASING = new SimpleOverlayRenderer(
            "multiblock_casing/silicon_carbide_casing");
    public static final SimpleOverlayRenderer ULV_STRUCTURAL_CASING = new SimpleOverlayRenderer(
            "multiblock_casing/ulv_structural_casing");
